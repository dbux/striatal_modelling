...
# rsync -ahisuvz "${DATA_DIR}/Scripts/" "ac1drb@sharc.sheffield.ac.uk:/home/ac1drb/scripts"
# rsync -ahisuvz "ac1drb@sharc.sheffield.ac.uk:/home/ac1drb/scripts/" "${DATA_DIR}/Scripts/"

# MatLab now synced via GitHub
# echo "Syncing MatLab scripts from ${DATA_DIR}/MatLab…"
# rsync -ahisuvz "${DATA_DIR}/MatLab/" "ac1drb@sharc.sheffield.ac.uk:/home/ac1drb/MatLab"
